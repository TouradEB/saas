...
export const pricingCards = [
    {
      title: 'Starter',
      description: 'Perfect for trying out Ebnu',
      price: 'Free',
      duration: '',
    ...
    },
    {
      ...
      priceId: 'price_1P2YCoLtUZiYhybVNbvnCEbX',
    },
    {
      title: 'Basic',
      ...
      priceId: 'price_1P2YADLtUZiYhybVrbRB6t9P',
    },
  ];
//  WIP change priority support
  export const addOnProducts = [
    { title: 'Priority Support', id: 'prod_PsJAdGDCVt5bs7' },
  ]
